...
import 'package:music_player/Views/MusicPlayer/Screens/Home/saavn.dart';
import 'package:music_player/Views/MusicPlayer/Screens/Library/library.dart';
...
import 'package:music_player/Views/MusicPlayer/Screens/Settings/setting.dart';
import 'package:music_player/Views/MusicPlayer/Screens/Top Charts/top.dart';
import 'package:music_player/Views/MusicPlayer/Screens/YouTube/youtube_home.dart';
    ...
    if (!checked && Theme.of(context).platform == TargetPlatform.android) {
      ...
      PackageInfo.fromPlatform().then((PackageInfo packageInfo) {
        ...
        if (autoBackup) {
          ...
          ExtStorageProvider.getExtStorage(dirName: 'music_player/Views/MusicPlayer/Backups')
              .then((value) {
            createBackup(
              context,
              checked,
              boxNames,
              path: value,
              fileName: 'music_player/Views/MusicPlayer_AutoBackup',
              showDialog: false,
            );
          });
        }
