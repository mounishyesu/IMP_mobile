...
import 'package:music_player/Views/MusicPlayer/CustomWidgets/popup.dart';
import 'package:music_player/Views/MusicPlayer/CustomWidgets/snackbar.dart';
import 'package:music_player/Views/MusicPlayer/CustomWidgets/textinput_dialog.dart';
import 'package:music_player/Views/MusicPlayer/Helpers/backup_restore.dart';
import 'package:music_player/Views/MusicPlayer/Helpers/config.dart';
...
import 'package:music_player/Views/MusicPlayer/Helpers/supabase.dart';
import 'package:music_player/Views/MusicPlayer/Screens/Home/saavn.dart' as home_screen;
import 'package:music_player/Views/MusicPlayer/Screens/Top Charts/top.dart' as top_screen;
import 'package:music_player/Views/MusicPlayer/Services/ext_storage_provider.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            Share.share(
                              '"shareAppText": https://github.com/Sangwan5688/music_player/Views/MusicPlayer',
                            );
                          },
                          dense: true,
                        ),
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            const String upiUrl =
                                'upi://pay?pa=8570094149@okbizaxis&pn=music_player/Views/MusicPlayer&mc=5732&aid=uGICAgIDn98OpSw&tr=BCR2DN6T37O6DB3Q';
                            launch(upiUrl);
                          },
                          onLongPress: () {
                            copyToClipboard(
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                Navigator.pop(context);
                                                launch(
                                                  'https://mail.google.com/mail/?extsrc=mailto&url=mailto%3A%3Fto%3Dmusic_player/Views/MusicPlayeryoucantescape%40gmail.com%26subject%3DRegarding%2520Mobile%2520App',
                                                );
                                              },
                                            ),
                                            Text(
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                Navigator.pop(context);
                                                launch(
                                                  'https://t.me/music_player/Views/MusicPlayer_official',
                                                );
                                              },
                                            ),
                                            Text(
