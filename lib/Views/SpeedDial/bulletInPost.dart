...
class BulletInPost extends StatefulWidget {
  ...
  @override
  _BulletInPostState createState() => _BulletInPostState();
}
                          ...
                          onTap: () {
                            setState(() {
                              if (url.text.length > 0) {
                                isList_visible = true;
                                urlList.add(url.text.toString());
                              } else {
                                Utilities.showAlert(
                                    context, "Empty text cannot be taken");
                              }
                              url.clear();
                            });
                          },
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextButton(
                          ...
                          onPressed: () {
                            print(_controller!.getTags!.toString());
                            // Navigator.pop(context);
                          },
                        ),
                      ),
...
// Position for popup menu
  ...
  getTaggedusers() async {
    ApiService.getcall("app-tag-users-companys").then((success) async {
      final body = json.decode(success);
      print("response====================================");
