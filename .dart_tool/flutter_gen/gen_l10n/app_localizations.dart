...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'music_player/Views/MusicPlayer'**
  String get appTitle;
  ...
  ///
  /// In en, this message translates to:
  /// **'If you downloaded music_player/Views/MusicPlayer from any app repository like \'F-Droid\', \'IzzyOnDroid\', etc which provide update options, keep this OFF. Whereas, If you downloaded it from \'GitHub\' or any other source which doesn\'t provide auto updates then turn this ON, so as to recieve update alerts\n'**
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'bn', 'cs', 'de', 'en', 'es', 'fr', 'gu', 'hi', 'id', 'it', 'kn', 'ml', 'ne', 'or', 'pl', 'pt', 'ru', 'ta', 'tr', 'vi', 'zh'].contains(locale.languageCode);
